...
(map! :leader
      :desc "split vertically window and follow"
      "w v" #'+evil/window-vsplit-and-follow)
(map! :leader
      :desc "split window only"
      "w V" #'evil-window-split)
(map! :leader
      :desc "split vertically only"
...
(map! :desc "Navigate window right"
      :nvirg
      "C-l" #'evil-window-right)
(map! :desc "Navigate window down"
      :nvirg
      "C-d" #'evil-window-down)
(map! :desc "Navigate window up"
      :nvirg
      "C-k" #'evil-window-up)
